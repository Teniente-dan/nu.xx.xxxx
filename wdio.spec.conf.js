exports.config = {
    wdi5: {
        screenshotPath: "./uimodule/webapp/test/wdi5/__screenshots__",
        ...
        url: "/test/mockServer.html", // [mandatory] {string} name of your bootstrap html file. If your server autoredirects to a 'domain:port/'-like root url, use empty string ''
    ...
    //
    specs: ["./uimodule/webapp/test/wdi5/Groups/SpecificTest/*.test.js"],
    // Patterns to exclude.
    exclude: [
                ...
                prefs: {
                    directory_upgrade: true,
                        prompt_for_download: false,
                            "download.default_directory": `C:\\Users\\${process.env.USERNAME}\\Downloads\\`,
                },
                args:
                    process.argv.indexOf("--headless") > -1
                        ? ["--headless"]
                        : process.argv.indexOf("--debug") > -1
                        ? ["window-size=900,800", "--auto-open-devtools-for-tabs"]
                        : ["window-size=900,800"]
            },
